...
main :: proc() {
    ...
    gl.BufferData(gl.ARRAY_BUFFER, byte_size_slice(vertices), mem.raw_data(vertices), gl.STATIC_DRAW)
    ...
    gl.VertexAttribPointer(auto_cast vcol_location, 3, gl.FLOAT, gl.FALSE, size_of(vertices[0]), (size_of(f32) * 2))
