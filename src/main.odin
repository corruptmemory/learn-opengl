...
main :: proc() {
	...
	if err := lft.load_font(llft, freetype, "/usr/share/fonts/fira-sans-condensed/FiraSansCondensed-Regular.ttf"); err != 0 {
	...
	for !glfw.WindowShouldClose(window) {
		...
		llft.projection = mat4Ortho3d(0.0, f32(width), 0.0, f32(height))
		...
		lft.draw_text(llft, "This :iiii:s: IIISISIS sample text", 10.0, 100.0, 36.0, glsl.vec3{1, 1, 1})
